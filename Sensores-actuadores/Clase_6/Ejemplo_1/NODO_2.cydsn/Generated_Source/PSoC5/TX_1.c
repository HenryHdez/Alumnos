...
*
* \funcusage
*  \snippet TX_1_SUT.c usage_TX_1_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet TX_1_SUT.c usage_TX_1_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet TX_1_SUT.c usage_TX_1_Read  
*******************************************************************************/
...
* preferred TX_1_Read() API because the 
* TX_1_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet TX_1_SUT.c usage_TX_1_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: TX_1_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use TX_1_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - TX_1_0_INTR       (First pin in the list)
    *  - TX_1_1_INTR       (Second pin in the list)
    *  - ...
    *  - TX_1_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet TX_1_SUT.c usage_TX_1_SetInterruptMode
    *******************************************************************************/
    void TX_1_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & TX_1_0_INTR) != 0u) 
		{ 
			 TX_1_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet TX_1_SUT.c usage_TX_1_ClearInterrupt
    *******************************************************************************/
