// ======================================================================
// Termocupla.v generated from TopDesign.cysch
// 09/02/2024 at 11:21
...
module ADC_DelSig_v3_30_0 (
	...
	cy_clock_v1_0
		#(.id("5597006b-a1ab-4e59-bbe2-41863de063e8/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("5597006b-a1ab-4e59-bbe2-41863de063e8/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("44e6acb5-12f1-40b8-809b-7fa0322bc80b/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__T1_net;
	wire [0:0] tmpFB_0__T1_net;
	wire [0:0] tmpIO_0__T1_net;
	wire [0:0] tmpINTERRUPT_0__T1_net;
	electrical [0:0] tmpSIOVREF__T1_net;
	...
	cy_psoc3_pins_v1_10
		...
		T1
		 (.oe(tmpOE__T1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__T1_net[0:0]}),
		  .analog({Net_1}),
		  .io({tmpIO_0__T1_net[0:0]}),
		  .siovref(tmpSIOVREF__T1_net),
		  .interrupt({tmpINTERRUPT_0__T1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__T1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__T2_net;
	wire [0:0] tmpFB_0__T2_net;
	wire [0:0] tmpIO_0__T2_net;
	wire [0:0] tmpINTERRUPT_0__T2_net;
	electrical [0:0] tmpSIOVREF__T2_net;

	cy_psoc3_pins_v1_10
		#(.id("a5b19a0b-0fa1-46e1-ab05-60ce9504b4ac"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 TC_1 (
        .connect({
            Net_11,
            Net_10
        })
    );
    defparam TC_1.comp_name = "Thermocouple_v1_0";
    defparam TC_1.port_names = "N, P";
    defparam TC_1.width = 2;
