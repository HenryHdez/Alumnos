// ======================================================================
// Emisor.v generated from TopDesign.cysch
// 07/10/2025 at 19:49
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("1eea9a8f-f7b7-4514-8a24-1bb28d3349ec/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    UART_v2_50_0 Emisor (
        ...
        .tx_en(Net_12),
        .tx_interrupt(Net_13));
    defparam Emisor.Address1 = 0;
    defparam Emisor.Address2 = 0;
    defparam Emisor.EnIntRXInterrupt = 0;
    defparam Emisor.EnIntTXInterrupt = 0;
    defparam Emisor.FlowControl = 0;
    defparam Emisor.HalfDuplexEn = 0;
    defparam Emisor.HwTXEnSignal = 1;
    defparam Emisor.NumDataBits = 8;
    defparam Emisor.NumStopBits = 1;
    defparam Emisor.ParityType = 0;
    defparam Emisor.RXEnable = 1;
    defparam Emisor.TXEnable = 1;
