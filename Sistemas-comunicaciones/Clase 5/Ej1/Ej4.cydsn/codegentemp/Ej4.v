// ======================================================================
// Ej4.v generated from TopDesign.cysch
// 07/10/2025 at 19:15
...
module top ;
	...
	cy_clock_v1_0
		#(.id("2e23712f-9e9e-4b98-ae3e-7a6e11ea6a0e"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("40000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Salida_net;
	wire [0:0] tmpFB_0__Salida_net;
	wire [0:0] tmpIO_0__Salida_net;
	wire [0:0] tmpINTERRUPT_0__Salida_net;
	electrical [0:0] tmpSIOVREF__Salida_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Salida
		 (.oe(tmpOE__Salida_net),
		  .y({Net_30}),
		  .fb({tmpFB_0__Salida_net[0:0]}),
		  .io({tmpIO_0__Salida_net[0:0]}),
		  .siovref(tmpSIOVREF__Salida_net),
		  .interrupt({tmpINTERRUPT_0__Salida_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Salida_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
