...
/* Default Config
* ADC_CFG1 Sample Rate: 180 Samples per Second
...
#define ADC_CFG1_CLOCK_FREQ         (2949120u)
#define ADC_CFG1_CP_CLOCK_FREQ      (11796480u)
#define ADC_CFG1_REFERENCE_VOLTAGE  (1.0240)
#define ADC_CFG1_COUNTS_PER_VOLT    (512000)
