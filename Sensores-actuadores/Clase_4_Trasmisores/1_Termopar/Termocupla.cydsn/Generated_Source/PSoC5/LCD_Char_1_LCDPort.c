...
*
* \funcusage
*  \snippet LCD_Char_1_LCDPort_SUT.c usage_LCD_Char_1_LCDPort_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet LCD_Char_1_LCDPort_SUT.c usage_LCD_Char_1_LCDPort_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet LCD_Char_1_LCDPort_SUT.c usage_LCD_Char_1_LCDPort_Read  
*******************************************************************************/
...
* preferred LCD_Char_1_LCDPort_Read() API because the 
* LCD_Char_1_LCDPort_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet LCD_Char_1_LCDPort_SUT.c usage_LCD_Char_1_LCDPort_ReadDataReg 
*******************************************************************************/
