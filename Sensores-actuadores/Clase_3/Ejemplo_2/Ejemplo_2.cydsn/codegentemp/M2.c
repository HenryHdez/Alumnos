...
{
    uint8 staticBits = (M2_DR & (uint8)(~M2_MASK));
    M2_DR = staticBits | ((uint8)(value << M2_SHIFT) & M2_MASK);
}
...
{
	CyPins_SetPinDriveMode(M2_0, mode);
}
...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		if((position & M2_0_INTR) != 0u) 
		{ 
			 M2_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (M2_INTSTAT & M2_MASK) >> M2_SHIFT;
    }
