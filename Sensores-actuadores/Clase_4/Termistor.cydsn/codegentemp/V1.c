...
{
    uint8 staticBits = (V1_DR & (uint8)(~V1_MASK));
    V1_DR = staticBits | ((uint8)(value << V1_SHIFT) & V1_MASK);
}
...
{
	CyPins_SetPinDriveMode(V1_0, mode);
}
...
/* If interrupt is connected for this Pins component */ 
    ...
    *******************************************************************************/
    ...
    {
		if((position & V1_0_INTR) != 0u) 
		{ 
			 V1_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (V1_INTSTAT & V1_MASK) >> V1_SHIFT;
    }
