// ======================================================================
// Termistor.v generated from TopDesign.cysch
// 09/02/2024 at 11:40
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("e5051ff1-c12e-479b-ad95-4f660732468d/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__V_Nodo_net;
	wire [0:0] tmpFB_0__V_Nodo_net;
	wire [0:0] tmpIO_0__V_Nodo_net;
	wire [0:0] tmpINTERRUPT_0__V_Nodo_net;
	electrical [0:0] tmpSIOVREF__V_Nodo_net;
	...
	cy_psoc3_pins_v1_10
		...
		V_Nodo
		 (.oe(tmpOE__V_Nodo_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__V_Nodo_net[0:0]}),
		  .analog({Net_9}),
		  .io({tmpIO_0__V_Nodo_net[0:0]}),
		  .siovref(tmpSIOVREF__V_Nodo_net),
		  .interrupt({tmpINTERRUPT_0__V_Nodo_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__V_Nodo_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("f74e025b-8a4c-4c11-a1c3-c6577867948d"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d2c4db30-9868-4d83-b713-70dd1326fe9e"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
