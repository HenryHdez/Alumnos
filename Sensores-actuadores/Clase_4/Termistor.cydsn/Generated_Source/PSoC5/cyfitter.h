...
/* V1 */
#define V1__0__INTTYPE CYREG_PICU0_INTTYPE2
#define V1__0__MASK 0x04u
#define V1__0__PC CYREG_PRT0_PC2
#define V1__0__PORT 0u
#define V1__0__SHIFT 2u
#define V1__AG CYREG_PRT0_AG
#define V1__AMUX CYREG_PRT0_AMUX
#define V1__BIE CYREG_PRT0_BIE
#define V1__BIT_MASK CYREG_PRT0_BIT_MASK
#define V1__BYP CYREG_PRT0_BYP
#define V1__CTL CYREG_PRT0_CTL
#define V1__DM0 CYREG_PRT0_DM0
#define V1__DM1 CYREG_PRT0_DM1
#define V1__DM2 CYREG_PRT0_DM2
#define V1__DR CYREG_PRT0_DR
#define V1__INP_DIS CYREG_PRT0_INP_DIS
#define V1__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define V1__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define V1__LCD_EN CYREG_PRT0_LCD_EN
#define V1__MASK 0x04u
#define V1__PORT 0u
#define V1__PRT CYREG_PRT0_PRT
#define V1__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define V1__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define V1__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define V1__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define V1__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define V1__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define V1__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define V1__PS CYREG_PRT0_PS
#define V1__SHIFT 2u
#define V1__SLW CYREG_PRT0_SLW

/* V2 */
#define V2__0__INTTYPE CYREG_PICU0_INTTYPE3
#define V2__0__MASK 0x08u
#define V2__0__PC CYREG_PRT0_PC3
#define V2__0__PORT 0u
#define V2__0__SHIFT 3u
#define V2__AG CYREG_PRT0_AG
#define V2__AMUX CYREG_PRT0_AMUX
#define V2__BIE CYREG_PRT0_BIE
#define V2__BIT_MASK CYREG_PRT0_BIT_MASK
#define V2__BYP CYREG_PRT0_BYP
#define V2__CTL CYREG_PRT0_CTL
#define V2__DM0 CYREG_PRT0_DM0
#define V2__DM1 CYREG_PRT0_DM1
#define V2__DM2 CYREG_PRT0_DM2
#define V2__DR CYREG_PRT0_DR
#define V2__INP_DIS CYREG_PRT0_INP_DIS
#define V2__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define V2__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define V2__LCD_EN CYREG_PRT0_LCD_EN
#define V2__MASK 0x08u
#define V2__PORT 0u
#define V2__PRT CYREG_PRT0_PRT
#define V2__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define V2__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define V2__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define V2__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define V2__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define V2__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define V2__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define V2__PS CYREG_PRT0_PS
#define V2__SHIFT 3u
#define V2__SLW CYREG_PRT0_SLW
...
/* V_Nodo */
#define V_Nodo__0__INTTYPE CYREG_PICU0_INTTYPE4
#define V_Nodo__0__MASK 0x10u
#define V_Nodo__0__PC CYREG_PRT0_PC4
#define V_Nodo__0__PORT 0u
#define V_Nodo__0__SHIFT 4u
#define V_Nodo__AG CYREG_PRT0_AG
#define V_Nodo__AMUX CYREG_PRT0_AMUX
#define V_Nodo__BIE CYREG_PRT0_BIE
#define V_Nodo__BIT_MASK CYREG_PRT0_BIT_MASK
#define V_Nodo__BYP CYREG_PRT0_BYP
#define V_Nodo__CTL CYREG_PRT0_CTL
#define V_Nodo__DM0 CYREG_PRT0_DM0
#define V_Nodo__DM1 CYREG_PRT0_DM1
#define V_Nodo__DM2 CYREG_PRT0_DM2
#define V_Nodo__DR CYREG_PRT0_DR
#define V_Nodo__INP_DIS CYREG_PRT0_INP_DIS
#define V_Nodo__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define V_Nodo__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define V_Nodo__LCD_EN CYREG_PRT0_LCD_EN
#define V_Nodo__MASK 0x10u
#define V_Nodo__PORT 0u
#define V_Nodo__PRT CYREG_PRT0_PRT
#define V_Nodo__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define V_Nodo__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define V_Nodo__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define V_Nodo__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define V_Nodo__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define V_Nodo__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define V_Nodo__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define V_Nodo__PS CYREG_PRT0_PS
#define V_Nodo__SHIFT 4u
#define V_Nodo__SLW CYREG_PRT0_SLW

/* Miscellaneous */
#define BCLK__BUS_CLK__HZ 24000000U
#define BCLK__BUS_CLK__KHZ 24000U
#define BCLK__BUS_CLK__MHZ 24U
#define CY_PROJECT_NAME "Termistor"
