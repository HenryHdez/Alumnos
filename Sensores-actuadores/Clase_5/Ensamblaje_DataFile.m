...
smiData.RigidTransform(1).translation = [-18.662153 -110.44369800000001 83.063654999999997];  % mm
smiData.RigidTransform(1).angle = 1.5707963267948968;  % rad
smiData.RigidTransform(1).axis = [0 0 1];
smiData.RigidTransform(1).ID = "SixDofRigidTransform[MC7H5yIVcr1pDYaN1]";

%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(2).translation = [47.668258000000002 249.08049600000001 83.156860999999992];  % mm
smiData.RigidTransform(2).angle = 1.5711009132952551;  % rad
smiData.RigidTransform(2).axis = [-0.01744974930950818 -0.01744974930950818 -0.99969545987669195];
smiData.RigidTransform(2).ID = "SixDofRigidTransform[MJJniJqj50kO0g5iO]";
...
%Translation Method - Cartesian
%Rotation Method - Arbitrary Axis
smiData.RigidTransform(4).translation = [9.586938 -129.24595600000001 102.550742];  % mm
smiData.RigidTransform(4).angle = 0;  % rad
smiData.RigidTransform(4).axis = [0 0 0];
smiData.RigidTransform(4).ID = "SixDofRigidTransform[Mk62tS/h+W1ug6NHc]";
...
smiData.Solid(1).ID = "JHD*:*11bf37a94bc6482c2b590be7";
...
smiData.Solid(2).color = [0.000000000 0.000000000 1.000000000];
smiData.Solid(2).opacity = 1.000000000;
smiData.Solid(2).ID = "JHD*:*bfd21b3c4ec36ff7830a4337";
...
smiData.Solid(3).color = [1.000000000 0.000000000 0.000000000];
smiData.Solid(3).opacity = 1.000000000;
smiData.Solid(3).ID = "JHD*:*d4364895e15b4c06b64581eb";
