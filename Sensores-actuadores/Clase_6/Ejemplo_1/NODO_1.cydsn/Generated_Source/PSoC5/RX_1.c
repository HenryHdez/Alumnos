...
*
* \funcusage
*  \snippet RX_1_SUT.c usage_RX_1_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet RX_1_SUT.c usage_RX_1_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet RX_1_SUT.c usage_RX_1_Read  
*******************************************************************************/
...
* preferred RX_1_Read() API because the 
* RX_1_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet RX_1_SUT.c usage_RX_1_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: RX_1_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use RX_1_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - RX_1_0_INTR       (First pin in the list)
    *  - RX_1_1_INTR       (Second pin in the list)
    *  - ...
    *  - RX_1_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet RX_1_SUT.c usage_RX_1_SetInterruptMode
    *******************************************************************************/
    void RX_1_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & RX_1_0_INTR) != 0u) 
		{ 
			 RX_1_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet RX_1_SUT.c usage_RX_1_ClearInterrupt
    *******************************************************************************/
