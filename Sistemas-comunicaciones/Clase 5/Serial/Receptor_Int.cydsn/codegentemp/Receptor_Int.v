// ======================================================================
// Receptor_Int.v generated from TopDesign.cysch
// 07/10/2025 at 20:34
...
module CharLCD_v2_20_1 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("b0f44dab-e11b-4745-9394-e35e0ca6beb0/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    UART_v2_50_0 Receptor (
        ...
        .tx_en(Net_12),
        .tx_interrupt(Net_13));
    defparam Receptor.Address1 = 0;
    defparam Receptor.Address2 = 0;
    defparam Receptor.EnIntRXInterrupt = 0;
    defparam Receptor.EnIntTXInterrupt = 0;
    defparam Receptor.FlowControl = 0;
    defparam Receptor.HalfDuplexEn = 0;
    defparam Receptor.HwTXEnSignal = 1;
    defparam Receptor.NumDataBits = 8;
    defparam Receptor.NumStopBits = 1;
    defparam Receptor.ParityType = 0;
    defparam Receptor.RXEnable = 1;
    defparam Receptor.TXEnable = 1;
