...
/* T1 */
#define T1__0__INTTYPE CYREG_PICU0_INTTYPE2
#define T1__0__MASK 0x04u
#define T1__0__PC CYREG_PRT0_PC2
#define T1__0__PORT 0u
#define T1__0__SHIFT 2u
#define T1__AG CYREG_PRT0_AG
#define T1__AMUX CYREG_PRT0_AMUX
#define T1__BIE CYREG_PRT0_BIE
#define T1__BIT_MASK CYREG_PRT0_BIT_MASK
#define T1__BYP CYREG_PRT0_BYP
#define T1__CTL CYREG_PRT0_CTL
#define T1__DM0 CYREG_PRT0_DM0
#define T1__DM1 CYREG_PRT0_DM1
#define T1__DM2 CYREG_PRT0_DM2
#define T1__DR CYREG_PRT0_DR
#define T1__INP_DIS CYREG_PRT0_INP_DIS
#define T1__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define T1__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define T1__LCD_EN CYREG_PRT0_LCD_EN
#define T1__MASK 0x04u
#define T1__PORT 0u
#define T1__PRT CYREG_PRT0_PRT
#define T1__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define T1__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define T1__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define T1__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define T1__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define T1__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define T1__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define T1__PS CYREG_PRT0_PS
#define T1__SHIFT 2u
#define T1__SLW CYREG_PRT0_SLW

/* T2 */
#define T2__0__INTTYPE CYREG_PICU0_INTTYPE3
#define T2__0__MASK 0x08u
#define T2__0__PC CYREG_PRT0_PC3
#define T2__0__PORT 0u
#define T2__0__SHIFT 3u
#define T2__AG CYREG_PRT0_AG
#define T2__AMUX CYREG_PRT0_AMUX
#define T2__BIE CYREG_PRT0_BIE
#define T2__BIT_MASK CYREG_PRT0_BIT_MASK
#define T2__BYP CYREG_PRT0_BYP
#define T2__CTL CYREG_PRT0_CTL
#define T2__DM0 CYREG_PRT0_DM0
#define T2__DM1 CYREG_PRT0_DM1
#define T2__DM2 CYREG_PRT0_DM2
#define T2__DR CYREG_PRT0_DR
#define T2__INP_DIS CYREG_PRT0_INP_DIS
#define T2__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU0_BASE
#define T2__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define T2__LCD_EN CYREG_PRT0_LCD_EN
#define T2__MASK 0x08u
#define T2__PORT 0u
#define T2__PRT CYREG_PRT0_PRT
#define T2__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define T2__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define T2__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define T2__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define T2__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define T2__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define T2__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define T2__PS CYREG_PRT0_PS
#define T2__SHIFT 3u
#define T2__SLW CYREG_PRT0_SLW
...
#define CY_PROJECT_NAME "Termocupla"
