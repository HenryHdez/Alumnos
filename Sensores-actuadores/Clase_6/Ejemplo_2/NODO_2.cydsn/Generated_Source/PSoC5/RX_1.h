...
/* Main Port Registers */
/* Pin State */
#define RX_1_PS                     (* (reg8 *) RX_1__PS)
/* Data Register */
#define RX_1_DR                     (* (reg8 *) RX_1__DR)
/* Port Number */
#define RX_1_PRT_NUM                (* (reg8 *) RX_1__PRT) 
/* Connect to Analog Globals */                                                  
#define RX_1_AG                     (* (reg8 *) RX_1__AG)                       
/* Analog MUX bux enable */
#define RX_1_AMUX                   (* (reg8 *) RX_1__AMUX) 
/* Bidirectional Enable */                                                        
#define RX_1_BIE                    (* (reg8 *) RX_1__BIE)
/* Bit-mask for Aliased Register Access */
#define RX_1_BIT_MASK               (* (reg8 *) RX_1__BIT_MASK)
/* Bypass Enable */
#define RX_1_BYP                    (* (reg8 *) RX_1__BYP)
/* Port wide control signals */                                                   
#define RX_1_CTL                    (* (reg8 *) RX_1__CTL)
/* Drive Modes */
#define RX_1_DM0                    (* (reg8 *) RX_1__DM0) 
#define RX_1_DM1                    (* (reg8 *) RX_1__DM1)
#define RX_1_DM2                    (* (reg8 *) RX_1__DM2) 
/* Input Buffer Disable Override */
#define RX_1_INP_DIS                (* (reg8 *) RX_1__INP_DIS)
/* LCD Common or Segment Drive */
#define RX_1_LCD_COM_SEG            (* (reg8 *) RX_1__LCD_COM_SEG)
/* Enable Segment LCD */
#define RX_1_LCD_EN                 (* (reg8 *) RX_1__LCD_EN)
/* Slew Rate Control */
#define RX_1_SLW                    (* (reg8 *) RX_1__SLW)

/* DSI Port Registers */
/* Global DSI Select Register */
#define RX_1_PRTDSI__CAPS_SEL       (* (reg8 *) RX_1__PRTDSI__CAPS_SEL) 
/* Double Sync Enable */
#define RX_1_PRTDSI__DBL_SYNC_IN    (* (reg8 *) RX_1__PRTDSI__DBL_SYNC_IN) 
/* Output Enable Select Drive Strength */
#define RX_1_PRTDSI__OE_SEL0        (* (reg8 *) RX_1__PRTDSI__OE_SEL0) 
#define RX_1_PRTDSI__OE_SEL1        (* (reg8 *) RX_1__PRTDSI__OE_SEL1) 
/* Port Pin Output Select Registers */
#define RX_1_PRTDSI__OUT_SEL0       (* (reg8 *) RX_1__PRTDSI__OUT_SEL0) 
#define RX_1_PRTDSI__OUT_SEL1       (* (reg8 *) RX_1__PRTDSI__OUT_SEL1) 
