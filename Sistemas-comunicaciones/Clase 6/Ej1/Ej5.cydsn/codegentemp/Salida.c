...
{
    uint8 staticBits = (Salida_DR & (uint8)(~Salida_MASK));
    Salida_DR = staticBits | ((uint8)(value << Salida_SHIFT) & Salida_MASK);
}
...
{
	CyPins_SetPinDriveMode(Salida_0, mode);
}
...
{
    return (Salida_PS & Salida_MASK) >> Salida_SHIFT;
}
...
{
    return (Salida_DR & Salida_MASK) >> Salida_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(Salida_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Salida_0_INTR) != 0u) 
		{ 
			 Salida_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (Salida_INTSTAT & Salida_MASK) >> Salida_SHIFT;
    }
