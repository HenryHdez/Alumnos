...
if __name__ == '__main__':
    ...
    if Carros:
        # Objeto actualizado
        Carros[0].modelo = 2025  
        transaction.commit()
        print(f'El modelo de {Carros[0].marca} ha sido actualizado a {Carros[0].modelo}')
    ...
    if Carros:
        ...
        del Carros[1]  
        transaction.commit()
        print('Se ha borrado un vehículo.')

    # Mostrar los objetos después de la actualización y eliminación
    for Car in Carros:
        print(f'La marca es {Car.marca} y el modelo {Car.modelo}')
